  ...
  return (
    <section name="portfolio" className='bg-gradient-to-b to-black from-gray-800 w-full text-white md:h-full  pt-8 pb-20 lg:px-12'>
      <article className='max-w-screen-lg p-4 pt-10 mx-auto flex flex-col justify-center w-full h-full '>
         ...
         {
            portfolios.map(({ id, alt,  src, code, live, type, site, icons }) => (
                  ...
                  <div  key={id} className='shadow-md shadow-gray-600 rounded-lg'>
                     <div>
                        ...
                        <div className='flex items-center justify-center'>
                           <button className='w-1/2 px-6 py-0 m-1 duration-200 hover:scale-105'><a href={live}>{site}</a></button>
                           <button className='w-1/2 px-6 py-0 m-1 duration-200 hover:scale-105'><a href={code}>{type}</a></button>
                        </div>
                     </div>
                  </div>               
               ))
