			...
			>
				<article className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
					<div>
						...
						<p className="py-6">
							I am available for coffee chats from fellow developers,
							project consultations, and interviews.
						</p>
						<p className="py-6">
							I am currently happy with my situation and not available
							for full time employment.
						</p>
						<p className="py-6">
							I am available for select freelance opportunities that
							pique my interest and provide a challenge.
						</p>
						<p className="py-6">
							<a
